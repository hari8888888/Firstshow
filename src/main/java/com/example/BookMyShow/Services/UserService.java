...
public class UserService {
    ...
    public String addUser(AddUserRequest addUserRequest){
        ...
        BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder(12); //BCrypt automatically handles salting and iterative hashing to protect stored passwords
